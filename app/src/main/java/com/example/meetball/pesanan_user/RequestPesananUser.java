...
public class RequestPesananUser {
    ...
    public RequestPesananUser(){

    }

    public RequestPesananUser(String nama, String noMeja, String pesanan1, String jumlahpesanan1, String pesanan2, String jumlahPesanan2, String keterangan, String status) {
        this.nama = nama;
        this.noMeja = noMeja;
    ...
    public void setJumlahPesanan2(String jumlahPesanan2) {
        this.jumlahPesanan2 = jumlahPesanan2;
    }
